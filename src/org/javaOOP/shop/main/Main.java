...
public class Main {
        public static void main(String[] args) {
                ...
                Smartphone iphone16 = new Smartphone("Iphone16", "APPLE", BigDecimal.valueOf(1299.00),
                                125.7f);
                ...
                System.out.println(
                                String.format("---%s---\n%s-%d\nIMEI : %d\nPrezzo: %.2f + %.0f%% iva\nMemory:%.2f GB\n",
                                                ...
                                                iphone16.getIva().multiply(BigDecimal.valueOf(100)).setScale(2,
                                                                RoundingMode.DOWN),
                                                iphone16.getMemory()));
                ...
                TV primaTV = new TV("TV camera", "Thomson", BigDecimal.valueOf(456.00), 26.5f,
                                57.8f,
                                5.2f, false);
                ...
                System.out.println(
                                String.format(
                                                ...
                                                primaTV.getIva().multiply(BigDecimal.valueOf(100)).setScale(2,
                                                                RoundingMode.DOWN),
                                                primaTV.getSmart()));
                ...
                Cuffie cuffia1 = new Cuffie("cuffia mia", "Samsung", BigDecimal.valueOf(56.00), "blu",
                                true);
